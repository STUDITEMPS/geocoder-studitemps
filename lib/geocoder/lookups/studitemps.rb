...
module Geocoder::Lookup
  ...
  class Studitemps < Base
    ...
    def get_auth0_token
      return configuration[:cache_store].read("auth0_token") if configuration[:cache_store]&.read("auth0_token")

      configuration[:cache_store]&.write("auth0_token", auth0_access_token.token, expires_in: auth0_access_token.expires_in - 10)
